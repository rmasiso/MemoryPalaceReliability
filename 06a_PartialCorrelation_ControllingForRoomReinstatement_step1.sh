...
#SBATCH -o /jukebox/norman/rmasis/MemPal/analysis/MemPal2024/PythonData2024/Logs/reliability2evidence_controlroom/slurm_-%j_%a.log
...
# measure_key=$3 #sys.argv[3] #'reliability' # sys.argv[2] #'reliability', distinctiveness
network=$2 #sys.argv[4] #'ROCN' # sys.argv[3] #'ROCN'
trial_type=$3  #sys.argv[5] #'GR' # sys.argv[4] #'GR', 'FR'
...
python 06a_PartialCorrelation_ControllingForRoomReinstatement_step2.py $hem $network $trial_type
