...
#SBATCH -o /jukebox/norman/rmasis/MemPal/analysis/MemPal2024/PythonData2024/Logs/classifyrecalls/slurm_-%j_%a.log
...
# sbatch 09a_ClassifyRecalls_RoomsOnObjectEvents_step1.sh SL rooms L
# sbatch 09a_ClassifyRecalls_RoomsOnObjectEvents_step1.sh SL rooms R
...
python 04a2_ClassifyRecalls_RoomsOnObjectEvents_step2.py $roi $betatypes $hems
